...
export const agent: Record<keyof typeof zh, string> = {
  ...
  "agent.chatModelGroup": "Chat model",
  "agent.tierGroup": "Style",
  "agent.tierHint": "Style only tunes creativity and length — the model stays the same",
  "agent.turnCredits": "{n} credits/turn",
  "agent.tier.fast": "Fast",
  "agent.tier.balanced": "Balanced",
  "agent.tier.quality": "Crafted",

  "agent.imageChip": "Image: {name}",
  "agent.videoChip": "Video: {name}",
  "agent.auto": "Auto",
  "agent.autoDesc": "The agent picks from {n} available products; the proposal names the product and price",
