...
> 当前真相以下列文档为准:设计书 [`docs/design.md`](design.md)(rev 4,as-built)、计划书 [`docs/plan.md`](plan.md)、审查报告 [`docs/review-2026-08-29.md`](review-2026-08-29.md)。本文保留作为决策依据(Key Decisions、Grok 能力矩阵、Alternatives)。
