...
| 项 | 状态 |
| --- | --- |
| 代码基线 | `main`/`origin/main` = `5bbdc97`（已推送；比生产多一条纯文档提交，见下一行）：`315818c` 会话/画布/终态 run 归档（`ARCHIVE_INACTIVE_DAYS`）、`8b5282f`+`0359830` 发布目录化 deploy 脚本（R1.4）、`6cc1611` 全仓审查报告（`docs/review-2026-09-15.md`）、`d8d326c`+`5087706` 整站背景呼吸灯与等待特效、`83065c7` 令牌文档对齐。精确 SHA 用 `git rev-parse HEAD origin/main` 核对 |
